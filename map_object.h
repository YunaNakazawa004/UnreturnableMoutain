...
// マクロ定義
//************************************************************************
#define MAX_MAP_OBJECT			(6000)			// 持てるオブジェクトの最大数
...
public:
	...
	enum MAP_OBJ
	{
		MAP_OBJ_TREE_C0 = 0,	// 収集アイテム
		MAP_OBJ_TREE_C1,		// 収集アイテム
		MAP_OBJ_ROCK_C0,		// 収集アイテム
		MAP_OBJ_ROCK_C1,		// 収集アイテム
		MAP_OBJ_FLOWER_C0,		// 収集アイテム
		MAP_OBJ_FLOWER_C1,		// 収集アイテム
		MAP_OBJ_LEAF_C0,		// 収集アイテム
		MAP_OBJ_LEAF_C1,		// 収集アイテム
		MAP_OBJ_GRASS,			// 草
		MAP_OBJ_TREE,			// 木
		MAP_OBJ_ROCK,			// 岩
		MAP_OBJ_FLOWER,			// 花
